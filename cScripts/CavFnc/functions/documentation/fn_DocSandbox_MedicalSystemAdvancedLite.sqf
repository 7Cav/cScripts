 ...
 *
 * Example:
 * call cScripts_fnc_DocSandbox_MedicalSystemAdvancedEasy;
 */

player createDiaryRecord["7Cav",
    ["Medical System Advanced (Easy)",
        "
<p>You are running the Advanced Easy Medical System. This system allows for a more friendly experience usign the ACE advanced medical system.<br/><br/>
