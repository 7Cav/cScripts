...
if (_platoonSelector == "bravo") then {
    ...
    _crate addWeaponCargoGlobal ["rhsusf_acc_eotech_552",50];
    _crate addWeaponCargoGlobal ["tf47_optic_m3maaws",10];
...
if (_platoonSelector == "medical") then {
    ...
    _crate addWeaponCargoGlobal ["rhsusf_acc_eotech_552",10];
...
if (_platoonSelector == "heavyweapons") then {
    ...
    _crate addWeaponCargoGlobal ["ACE_VMH3",20];
    _crate addWeaponCargoGlobal ["ACE_VMM3",20];
    _crate addWeaponCargoGlobal ["ACE_IR_Strobe_Item",20];
...
if (_platoonSelector == "ranger") then {
    ...
    _crate addWeaponCargoGlobal ["rhsusf_acc_compm4",50];
    _crate addWeaponCargoGlobal ["rhsusf_acc_ACOG_RMR",50];
    _crate addWeaponCargoGlobal ["rhsusf_acc_eotech_552",50];
    _crate addWeaponCargoGlobal ["rhsusf_acc_anpeq15_bk_light",50];
    _crate addWeaponCargoGlobal ["rhsusf_acc_anpeq15A",50];
    _crate addWeaponCargoGlobal ["rhsusf_acc_nt4_black",50];
    _crate addWeaponCargoGlobal ["rhsusf_acc_harris_bipod",50];
    _crate addWeaponCargoGlobal ["rhsusf_acc_grip1",50];
    _crate addWeaponCargoGlobal ["tf47_optic_m3maaws",50];
    ...
    _crate addWeaponCargoGlobal ["ItemcTab",20];
    _crate addWeaponCargoGlobal ["ACE_microDAGR",20];
    _crate addWeaponCargoGlobal ["ACE_Vector",20];
    _crate addWeaponCargoGlobal ["Leupold_Mk4",20];
    _crate addWeaponCargoGlobal ["ACE_MX2A",20];
    _crate addWeaponCargoGlobal ["Laserdesignator_01_khk_F",20];
    _crate addWeaponCargoGlobal ["ACE_Altimeter",20];
...
if (_platoonSelector == "sniper") then {
    ...
    _crate addWeaponCargoGlobal ["rhsusf_acc_premier_anpvs27",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_M8541_low",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_M2010S_wd",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_SR25S",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_M2010S_wd",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_M2010S_wd",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_compm4",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_ACOG_RMR",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_eotech_552",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_anpeq15_bk_light",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_anpeq15A",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_nt4_black",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_harris_bipod",2];
    _crate addWeaponCargoGlobal ["rhsusf_acc_grip1",2];
