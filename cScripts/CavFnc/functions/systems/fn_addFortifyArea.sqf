...
missionNamespace setVariable ["acex_fortify_locations", [[_vehicle, _radius, _radius, 0, false]], true];
...
_action = ["Fortify_Check_Vehcile", "Check Vehicle", "", _statement, {true}, {}, [_radius, _restriction]] call ace_interact_menu_fnc_createAction;
