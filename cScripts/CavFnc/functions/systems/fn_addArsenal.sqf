...
private _bravo_arsenal = [
    ...
    "ACRE_PRC152","ACE_quikclot","ACE_tourniquet","ACE_personalAidKit","ACE_EarPlugs","ACE_MapTools","ACE_CableTie","ACE_microDAGR","ACE_HuntIR_monitor","ACE_SpraypaintRed","ACE_EntrenchingTool","ItemcTab","ItemMap","ItemWatch","ToolKit","ItemAndroid","ACE_morphine",
    // bravo Loadout Gear Export
    "rhsusf_ANPVS_14","rhsusf_ach_helmet_headset_ocp","rhsusf_shemagh_gogg_tan","rhs_uniform_cu_ocp_1stcav","rhsusf_iotv_ocp_Teamleader","rhsusf_cvc_green_helmet","rhsusf_iotv_ocp_Repair","rhs_googles_clear","rhsusf_iotv_ocp_Squadleader","rhsusf_iotv_ocp_SAW","rhsusf_iotv_ocp_Rifleman",
    // bravo Loadout Backpacks Export
    "B_Carryall_mcamo","B_AssaultPack_mcamo",

    // Crate Weapons Export
    "rhs_weap_m240B","rhs_weap_maaws","rhs_weap_M136_hp",
    // Crate Magazines Export
...
private _charlie_arsenal = [
    ...
    "rhs_weap_m4a1_carryhandle","rhsusf_acc_anpeq15A","rhsusf_acc_ACOG_RMR","ACE_Vector","rhs_weap_m4a1_m320","Laserdesignator","rhs_weap_m249_pip_L_para","Binocular","rhs_weap_M136_hp",
