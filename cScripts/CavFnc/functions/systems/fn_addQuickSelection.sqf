...
if (_category isEqualTo ["ACE_MainActions","cScriptQuickSelectionMenu","cScriptQuickSelection_Alpha"]) then {
    if (_requirePlatoonVariable) then {
        private _quickSelection_Alpha = [format ["cScriptQuickSelection_%1", _className], _lable, _icon, {[player, _this select 2] call Poppy_fnc_applyLoadout;}, {[ARR_2(player,'Alpha')] call FUNC(hasPlatoonVariable)}, {}, _className] call ace_interact_menu_fnc_createAction;
...
if (_category isEqualTo ["ACE_MainActions","cScriptQuickSelectionMenu","cScriptQuickSelection_Bravo"]) then {
    if (_requirePlatoonVariable) then {
        private _quickSelection_Bravo = [format ["cScriptQuickSelection_%1", _className], _lable, _icon, {[player, _this select 2] call Poppy_fnc_applyLoadout;}, {[ARR_2(player,'Bravo')] call FUNC(hasPlatoonVariable)}, {}, _className] call ace_interact_menu_fnc_createAction;
...
if (_category isEqualTo ["ACE_MainActions","cScriptQuickSelectionMenu","cScriptQuickSelection_Charlie"]) then {
    if (_requirePlatoonVariable) then {
        private _quickSelection_Charlie = [format ["cScriptQuickSelection_%1", _className], _lable, _icon, {[player, _this select 2] call Poppy_fnc_applyLoadout;}, {[ARR_2(player,'Charlie')] call FUNC(hasPlatoonVariable)}, {}, _className] call ace_interact_menu_fnc_createAction;
...
if (_category isEqualTo ["ACE_MainActions","cScriptQuickSelectionMenu","cScriptQuickSelection_Ranger"]) then {
    if (_requirePlatoonVariable) then {
        private _quickSelection_Ranger = [format ["cScriptQuickSelection_%1", _className], _lable, _icon, {[player, _this select 2] call Poppy_fnc_applyLoadout;}, {[ARR_2(player,'Ranger')] call FUNC(hasPlatoonVariable)}, {}, _className] call ace_interact_menu_fnc_createAction;
...
if (_category isEqualTo ["ACE_MainActions","cScriptQuickSelectionMenu","cScriptQuickSelection_Medical"]) then {
    if (_requirePlatoonVariable) then {
        private _quickSelection_Medical = [format ["cScriptQuickSelection_%1", _className], _lable, _icon, {[player, _this select 2] call Poppy_fnc_applyLoadout;}, {[ARR_2(player,'Medical')] call FUNC(hasPlatoonVariable)}, {}, _className] call ace_interact_menu_fnc_createAction;
