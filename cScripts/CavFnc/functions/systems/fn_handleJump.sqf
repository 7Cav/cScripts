...
if (("nvg" in _lostList) && ("hat" in _lostList) && ("gog" in _lostList)) exitWith { "Lost nvg hat gog" call CBA_fnc_notify; };
if (("nvg" in _lostList) && ("hat" in _lostList)) exitWith { "Lost nvg hat" call CBA_fnc_notify; };
if (("nvg" in _lostList) && ("gog" in _lostList)) exitWith { "Lost nvg gog" call CBA_fnc_notify; };
if (("hat" in _lostList) && ("gog" in _lostList)) exitWith { "Lost hat gog" call CBA_fnc_notify; };
if ("nvg" in _lostList) exitWith { "Lost nvg" call CBA_fnc_notify; };
if ("hat" in _lostList) exitWith { "Lost hat" call CBA_fnc_notify; };
if ("gog" in _lostList) exitWith { "Lost gog" call CBA_fnc_notify; };
