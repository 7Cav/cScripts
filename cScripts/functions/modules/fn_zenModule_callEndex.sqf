                ...
                {
                    {
                        [
                            ...
                            "fired",
                            {
                                ...
                                private _hftitle = format["<t color='#ffc61a' size='1.2' shadow='1' shadowColor='#000000' align='center'>%1 %2<br />hold your Fire!</t><br /><br />", [_unit, 'USA'] call EFUNC(player,getRank);, [_unit] call EFUNC(unit,getName)];
