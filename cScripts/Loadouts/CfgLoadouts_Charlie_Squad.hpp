...
class Cav_B_C_PlatoonMedic_F: Cav_B_C_Officer_F {
    ...
    scope = 2;
    loadout = [["rhs_weap_m4a1_blockII","rhsusf_acc_SF3P556","rhsusf_acc_anpeq15","rhsusf_acc_ACOG_RMR",["rhs_mag_30Rnd_556x45_M855A1_PMAG",30],[],""],[],[],["USP_G3C_RS_KP_OR_MC",[["ACE_tourniquet",8],["ACE_EarPlugs",1],["ACE_MapTools",1],["ACE_Flashlight_XL50",1],["ACE_IR_Strobe_Item",2],["ACE_CableTie",2],["USP_PVS15",1],["ACE_splint",6],["kat_Painkiller",2,4],["kat_Carbonate",1,10],["ACE_Chemlight_IR",2,1]]],["USP_CRYE_CPC_MEDIC_BELT_MC",[["ACE_surgicalKit",1],["kat_IV_16",15],["kat_atropine",4],["ACE_adenosine",1],["kat_chestSeal",10],["kat_EACA",4],["kat_ketamine",5],["kat_larynx",10],["kat_lidocaine",10],["kat_nalbuphine",10],["kat_naloxone",4],["kat_nitroglycerin",10],["kat_norepinephrine",6],["kat_phenylephrine",8],["kat_stethoscope",1],["kat_Pulseoximeter",5],["kat_IO_FAST",5],["kat_aatKit",5],["kat_phenylephrineAuto",6],["ACE_epinephrine",4],["ACE_microDAGR",1],["kat_epinephrineIV",4],["kat_pocketBVM",1],["SmokeShell",5,1],["rhs_mag_30Rnd_556x45_M855A1_PMAG",6,30],["SmokeShellBlue",2,1],["SmokeShellPurple",2,1],["kat_Penthrox",4,10]]],["USP_TACTICAL_PACK",[["ACE_plasmaIV",2],["ACE_plasmaIV_500",6],["ACE_elasticBandage",30],["ACE_packingBandage",20],["ACE_quikclot",10],["ACE_salineIV_250",2],["ACE_salineIV_500",2],["ACE_bloodIV",2],["ACE_bloodIV_500",6],["kat_accuvac",1]]],"USP_OPS_FASTXP_TAN_MC_03","USP_MFRAME_BLK2",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ACE_Altimeter",""]];
...
class Cav_B_C_SquadLeader_F: Cav_B_Charlie_base_F {
    ...
    scope = 2;
    category[] += {"cScripts_Loadout_Cat_Charlie_Leadership"};
    loadout = [["rhs_weap_m4a1","rhsusf_acc_SF3P556","rhsusf_acc_anpeq15_bk","rhsusf_acc_ACOG_RMR_3d",["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",30],[],""],[],[],["USP_G3C_RS2_KP_OR_MC",[["ACE_tourniquet",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_packingBandage",14],["kat_chestSeal",2],["kat_guedel",1],["ACE_EarPlugs",1],["ACE_splint",2],["ACE_SpraypaintRed",1],["kat_Painkiller",2,4]]],["USP_CRYE_JPC_TLB",[["USP_PVS15",1],["ACE_CableTie",2],["ACE_EntrenchingTool",1],["ACE_HuntIR_monitor",1],["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan_Tracer_Red",9,30],["SmokeShell",4,1],["HandGrenade",2,1],["SmokeShellPurple",1,1],["SmokeShellBlue",2,1]]],["USP_HYDRATION_PACK_MC",[]],"USP_OPSCORE_FASTMTC_CMGTW","",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ACE_Altimeter",""]];
    role = "squadleader";
    icon = "iconManLeader";
};
class Cav_B_C_FireTeamLeader_F: Cav_B_Charlie_base_F {
    ...
    scope = 2;
    category[] += {"cScripts_Loadout_Cat_Charlie_Rifle_Squad"};
    loadout = [["rhs_weap_m4a1","rhsusf_acc_SF3P556","rhsusf_acc_anpeq15_bk","rhsusf_acc_ACOG_RMR",["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",30],[],""],[],[],["USP_G3C_RS2_KP_OR_MC",[["ACE_tourniquet",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_packingBandage",14],["kat_chestSeal",2],["kat_guedel",1],["ACE_EarPlugs",1],["ACE_splint",2],["ACE_SpraypaintRed",1],["ACE_IR_Strobe_Item",1],["kat_Painkiller",2,4]]],["USP_CRYE_JPC_TLB",[["ACE_HuntIR_monitor",1],["ACE_EntrenchingTool",1],["ACE_CableTie",2],["USP_PVS15",1],["SmokeShell",4,1],["HandGrenade",2,1],["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan_Tracer_Red",9,30],["SmokeShellBlue",1,1],["SmokeShellPurple",1,1],["rhsusf_200Rnd_556x45_mixed_soft_pouch",1,200]]],["USP_ZIPON_PANEL_CPC_MC",[["rhsusf_200Rnd_556x45_mixed_soft_pouch",1,200]]],"USP_OPSCORE_FASTMTC_CGSW","",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ACE_Altimeter",""]];
    role = "fireteamleader";
    icon = "iconManLeader";
};
class Cav_B_C_AutomaticRifleman_F: Cav_B_Charlie_base_F {
    ...
    scope = 2;
    category[] += {"cScripts_Loadout_Cat_Charlie_Rifle_Squad"};
    loadout = [["rhs_weap_m249_light_S_vfg2","rhsusf_acc_SF3P556","rhsusf_acc_anpeq15side_bk","rhsusf_acc_ELCAN",["rhsusf_200Rnd_556x45_mixed_soft_pouch",200],[],"rhsusf_acc_grip4_bipod"],[],[],["USP_G3C_KP_OR_MC",[["ACE_tourniquet",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_packingBandage",14],["kat_chestSeal",2],["kat_guedel",1],["ACE_splint",2],["kat_Painkiller",2,4],["SmokeShell",3,1]]],["USP_CRYE_JPC_MGB",[["ACE_EntrenchingTool",1],["SmokeShell",1,1],["HandGrenade",2,1],["rhsusf_200Rnd_556x45_mixed_soft_pouch",4,200]]],[],"USP_OPSCORE_FASTMTC_CGSW","",["ACE_Vector","","","",[],[],""],["ItemMap","","","ItemCompass","ACE_Altimeter",""]];
    icon = "iconManMG";
};
class Cav_B_C_Grenadier_F: Cav_B_Charlie_base_F {
    ...
    scope = 2;
    category[] += {"cScripts_Loadout_Cat_Charlie_Rifle_Squad"};
    loadout = [["rhs_weap_m4a1_m320","rhsusf_acc_SF3P556","rhsusf_acc_anpeq15","rhsusf_acc_ACOG_RMR_3d",["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",30],["rhs_mag_M433_HEDP",1],""],[],[],["USP_G3C_RS_CU_KP_OR_MC",[["ACE_tourniquet",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_packingBandage",14],["kat_chestSeal",2],["kat_guedel",1],["ACE_splint",2],["ACE_EarPlugs",1],["kat_Painkiller",2,4],["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",1,30]]],["USP_CRYE_JPC_GRB",[["USP_PVS15",1],["SmokeShell",4,1],["HandGrenade",2,1],["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",8,30],["rhs_mag_M433_HEDP",11,1],["rhs_mag_m714_White",4,1],["rhs_mag_m713_Red",2,1],["ACE_HuntIR_M203",2,1]]],["USP_HYDRATION_PACK_MC",[["ACE_EntrenchingTool",1],["ACE_HuntIR_monitor",1],["rhs_mag_M433_HEDP",3,1],["ACE_HuntIR_M203",1,1]]],"USP_OPSCORE_FASTMTC_CGSW","",["ACE_Vector","","","",[],[],""],["ItemMap","","","ItemCompass","ACE_Altimeter",""]];
};
class Cav_B_C_RiflemanLAT_F: Cav_B_Charlie_base_F {
    displayName = "$STR_Cav_Charlie_Characters_C_RiflemanLAT";
    scope = 2;
    category[] += {"cScripts_Loadout_Cat_Charlie_Rifle_Squad"};
    loadout = [["rhs_weap_m4a1_blockII_KAC","rhsusf_acc_SF3P556","rhsusf_acc_anpeq15","rhsusf_acc_ACOG_RMR_3d",["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",30],[],""],["rhs_weap_M136_hedp","","","",[],[],""],[],["USP_G3C_RS_CU_KP_OR_MC",[["ACE_tourniquet",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_packingBandage",14],["kat_chestSeal",2],["kat_guedel",1],["ACE_splint",2],["kat_Painkiller",2,4]]],["USP_CRYE_JPC_ASLTB",[["USP_PVS15",1],["ACE_EntrenchingTool",1],["SmokeShell",4,1],["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",9,30],["HandGrenade",2,1]]],["USP_HYDRATION_PACK_MC",[]],"USP_OPSCORE_FASTMTC_CGSW","",["ACE_Vector","","","",[],[],""],["ItemMap","","","ItemCompass","ACE_Altimeter",""]];
    icon = "iconManAT";
};
