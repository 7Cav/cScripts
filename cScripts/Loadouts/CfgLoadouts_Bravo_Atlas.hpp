...
class Cav_B_B_Atlas_Medic_TeamLeader_F : Cav_B_Bravo_Atlas_base_F {
    ...
    scope = 2;
    loadout = [["rhs_weap_m4a1_mstock","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15_bk","rhsusf_acc_ACOG_RMR",["rhs_mag_30Rnd_556x45_M855A1_Stanag",30],[],"rhsusf_acc_tdstubby_blk"],[],[],["rhs_uniform_acu_ocp",[["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_EarPlugs",1],["ACE_splint",8],["ACRE_PRC343",1],["ACRE_PRC152",1],["ACE_Flashlight_XL50",1]]],["rhsusf_mbav_medic",[["ACE_CableTie",4],["ACE_surgicalKit",1],["ACE_EntrenchingTool",1],["ACE_SpraypaintBlue",1],["ACRE_PRC152",1],["rhs_mag_30Rnd_556x45_M855A1_Stanag",4,30],["rhs_mag_m67",1,1],["SmokeShell",4,1],["SmokeShellBlue",2,1],["SmokeShellGreen",2,1],["ACE_Chemlight_HiYellow",4,1],["ACE_Chemlight_HiRed",4,1],["B_IR_Grenade",2,1]]],["B_Carryall_mcamo",[["ACE_quikclot",25],["ACE_tourniquet",10],["ACE_personalAidKit",7],["rhsusf_ANPVS_14",1],["ACE_salineIV",10],["ACE_salineIV_500",4],["ACE_elasticBandage",40],["ACE_morphine",16],["ACE_epinephrine",16],["ACE_adenosine",2]]],"rhsusf_ach_bare_tan_headset","",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ItemWatch",""]];
    abilityMedic = 2;
};
class Cav_B_B_Atlas_Medic_CombatMedic_F : Cav_B_Bravo_Atlas_base_F {
    ...
    scope = 2;
    loadout = [["rhs_weap_m4a1_mstock","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15_bk","rhsusf_acc_compm4",["rhs_mag_30Rnd_556x45_M855A1_Stanag",30],[],"rhsusf_acc_grip3"],[],[],["rhs_uniform_acu_oefcp",[["ACE_MapTools",1],["ACE_Flashlight_XL50",1],["ACE_microDAGR",1],["ACE_EarPlugs",1],["ACE_CableTie",1],["ACE_splint",8],["ACRE_PRC343",1],["ACRE_PRC152",1]]],["rhsusf_mbav_medic",[["ACE_CableTie",2],["ACE_surgicalKit",1],["ACE_EntrenchingTool",1],["ACE_SpraypaintBlue",1],["ACE_elasticBandage",10],["ACE_adenosine",2],["rhs_mag_30Rnd_556x45_M855A1_Stanag",4,30],["rhs_mag_m67",1,1],["SmokeShell",4,1],["SmokeShellBlue",2,1],["SmokeShellGreen",2,1],["ACE_Chemlight_HiYellow",4,1],["ACE_Chemlight_HiRed",4,1],["B_IR_Grenade",2,1]]],["B_Carryall_mcamo",[["ACE_quikclot",25],["ACE_tourniquet",12],["ACE_personalAidKit",7],["rhsusf_ANPVS_14",1],["ACE_salineIV",10],["ACE_salineIV_500",4],["ACE_elasticBandage",40],["ACE_morphine",16],["ACE_epinephrine",16]]],"rhsusf_ach_bare_tan_headset","",[],["ItemMap","ItemAndroid","","ItemCompass","ItemWatch",""]];
    abilityMedic = 2;
};
