...
class Cav_B_B_Atlas_Medic_TeamLeader_F : Cav_B_Bravo_Atlas_base_F {
    ...
    scope = 2;
    loadout = [["rhs_weap_m4a1_carryhandle_mstock_grip","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15side_bk","rhsusf_acc_ACOG_RMR",["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red",30],[],"rhsusf_acc_grip1"],[],[],["B_ACU_crye_ocp_SH_1",[["kat_IV_16",10],["ACE_tourniquet",10],["kat_carbonate",2],["kat_Painkiller",2,10]]],["rhsusf_mbav_medic",[["ACE_morphine",8],["ACE_adenosine",6],["ACE_epinephrine",20],["ACE_surgicalKit",1],["ACE_EarPlugs",1],["ACE_microDAGR",1],["ACE_Flashlight_XL50",1],["ACE_IR_Strobe_Item",4],["ACE_SpraypaintBlue",1],["SmokeShell",6,1],["SmokeShellGreen",4,1],["SmokeShellBlue",2,1],["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red",4,30]]],["B_Carryall_cbr",[["ACE_elasticBandage",30],["ACE_splint",8],["ACE_packingBandage",30],["ACE_salineIV_500",10],["kat_TXA",10],["kat_naloxone",10],["kat_AED",1],["ACE_personalAidKit",2],["ACE_salineIV",10],["rhsusf_ANPVS_14",1]]],"rhsusf_opscore_ut_pelt_nsw","",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ItemWatch",""]];
