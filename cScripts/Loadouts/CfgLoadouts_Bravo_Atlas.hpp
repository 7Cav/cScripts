...
class Cav_B_B_Atlas_Medic_TeamLeader_F : Cav_B_Bravo_Atlas_base_F {
    ...
    scope = 2;
    loadout = [["rhs_weap_m4a1_mstock_grip3","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15_bk","rhsusf_acc_ACOG_RMR",["rhs_mag_30Rnd_556x45_M855A1_Stanag",30],[],"rhsusf_acc_tdstubby_blk"],[],[],["rhs_uniform_acu_ocp",[["ACRE_PRC343",1],["ACRE_PRC152",1],["ACE_microDAGR",1],["ACE_MapTools",1],["ACE_Flashlight_XL50",1],["ACE_CableTie",4],["ACE_EarPlugs",1]]],["rhsusf_mbav_medic",[["ACE_morphine",20],["ACE_epinephrine",20],["ACE_adenosine",6],["ACE_surgicalKit",1],["ACRE_PRC152",1],["rhs_mag_30Rnd_556x45_M855A1_Stanag",5,30],["SmokeShell",4,1],["SmokeShellBlue",2,1],["ACE_Chemlight_HiYellow",4,1],["ACE_Chemlight_HiRed",4,1]]],["B_Carryall_mcamo",[["ACE_quikclot",50],["ACE_tourniquet",14],["ACE_splint",8],["ACE_elasticBandage",40],["ACE_salineIV",10],["ACE_personalAidKit",6],["rhsusf_ANPVS_14",1]]],"rhsusf_ach_bare_tan_headset","",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ItemWatch",""]];
    abilityMedic = 2;
};
