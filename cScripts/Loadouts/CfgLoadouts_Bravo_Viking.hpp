...
class Cav_B_B_Scout_MachineGunner_F_Local : Cav_B_Bravo_base_F {
    displayName = "Scout M240 Machinegunner";
    scope = 2;
    category[] += {"cScripts_Loadout_Cat_Bravo_Viking_Squad"};
    loadout = [["rhs_weap_m240B","rhsusf_acc_ARDEC_M240","rhsusf_acc_anpeq16a","rhsusf_acc_su230a_mrds",["rhsusf_100Rnd_762x51_m62_tracer",100],[],""],[],["rhsusf_weap_glock17g4","","acc_flashlight_pistol","",["rhsusf_mag_17Rnd_9x19_FMJ",17],[],""],["USP_G3C_KP_OR_MC",[["ACRE_PRC343",1],["ACE_quikclot",16],["ACE_EarPlugs",1],["ACE_splint",2],["ACE_tourniquet",4],["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_Flashlight_XL50",1]]],["rhsusf_spcs_ocp_machinegunner",[["SmokeShellGreen",1,1],["HandGrenade",1,1],["SmokeShell",2,1],["rhsusf_mag_17Rnd_9x19_FMJ",2,17],["rhsusf_100Rnd_762x51_m62_tracer",3,100]]],["UK3CB_B_Backpack_Pocket",[["rhsusf_acc_anpas13gv1",1],["rhsusf_acc_ACOG_MDO",1],["rhsusf_100Rnd_762x51_m62_tracer",3,100]]],"USP_OPS_FASTXP_TAN_MC_04","USP_BALACLAVA_OAK_SMG1_CBR2",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ItemWatch","USP_PVS15"]];
    icon = "iconManMG";
};
