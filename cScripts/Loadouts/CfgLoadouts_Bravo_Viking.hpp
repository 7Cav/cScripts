...
class Cav_B_B_Scout_PlatoonMedic_F : Cav_B_Bravo_base_F {
    ...
    category[] += {"cScripts_Loadout_Cat_Bravo_Viking_Leadership"};
    scope = 2;
    loadout = [["rhs_weap_m4a1_mstock","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15_bk","rhsusf_acc_compm4",["rhs_mag_30Rnd_556x45_M855A1_Stanag",30],[],"rhsusf_acc_grip2"],[],[],["rhs_uniform_acu_oefcp",[["ACE_MapTools",1],["ACE_Flashlight_XL50",1],["ACE_microDAGR",1],["ACRE_PRC152",2],["ACRE_PRC343",1],["SmokeShellBlue",2,1]]],["rhsusf_spcs_ocp_medic",[["ACE_surgicalKit",1],["ACE_elasticBandage",12],["ACE_adenosine",2],["ACE_CableTie",4],["rhs_mag_30Rnd_556x45_M855A1_Stanag",6,30],["rhs_mag_m67",2,1],["SmokeShell",4,1],["ACE_Chemlight_HiRed",4,1],["ACE_Chemlight_HiYellow",4,1]]],["B_Kitbag_mcamo",[["ACE_quikclot",24],["ACE_tourniquet",12],["rhsusf_ANPVS_14",1],["ACE_personalAidKit",1],["ACE_elasticBandage",30],["ACE_morphine",20],["ACE_epinephrine",20],["ACE_salineIV",12],["ACE_splint",12]]],"rhsusf_ach_helmet_camo_ocp","rhs_googles_black",["rhsusf_bino_m24_ARD","","","",[],[],""],["ItemMap","ItemAndroid","ItemRadioAcreFlagged","ItemCompass","ACE_Altimeter",""]];
