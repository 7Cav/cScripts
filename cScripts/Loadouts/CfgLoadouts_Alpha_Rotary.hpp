...
class Cav_B_A_Helicopter_Tra_DoorGunner_F : Cav_B_Alpha_base_F {
    ...
    category[] += {"cScripts_Loadout_Cat_Alpha_Rotary"};
    scope = 2;
    loadout = [["rhs_weap_m4","","rhsusf_acc_anpeq15side_bk","rhsusf_acc_ACOG_RMR",["rhs_mag_30Rnd_556x45_M855A1_Stanag",30],[],""],[],["rhsusf_weap_m9","","","",["rhsusf_mag_15Rnd_9x19_JHP",15],[],""],["rhs_uniform_cu_ocp_1stcav",[["ACRE_PRC343",1],["ACRE_PRC152",1],["ACE_fieldDressing",24]]],["rhsusf_mbav_light",[["rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red",3,30],["rhsusf_mag_15Rnd_9x19_JHP",1,15],["SmokeShellBlue",2,1],["SmokeShellRed",2,1],["SmokeShellGreen",2,1],["Chemlight_green",2,1],["ACE_Chemlight_HiRed",2,1],["Chemlight_blue",2,1],["SmokeShell",2,1],["B_IR_Grenade",1,1]]],["B_Kitbag_mcamo",[["ACRE_PRC117F",1],["ACE_fieldDressing",16],["ACE_quikclot",40],["ACE_morphine",10],["ACE_epinephrine",10],["ACE_tourniquet",5],["ACE_EarPlugs",2],["ACE_CableTie",2],["ACE_microDAGR",1],["ACE_Flashlight_MX991",1],["ACE_MapTools",1],["ACE_EntrenchingTool",1],["ACE_Banana",1],["H_Cap_tan",1],["rhsusf_shemagh_tan",1],["NVGogglesB_grn_F",1]]],"rhsusf_hgu56p_visor_mask_black","",["Binocular","","","",[],[],""],["ItemMap","ItemAndroid","ItemRadioAcreFlagged","ItemCompass","ACE_Altimeter","NVGogglesB_blk_F"]];
};
