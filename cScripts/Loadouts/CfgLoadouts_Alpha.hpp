...
class Cav_B_A_JFO_F : Cav_B_Alpha_base_F {
    ...
    category[] += {"cScripts_Loadout_Cat_Alpha_Leadership"};
    scope = 2;
    loadout = [["rhs_weap_m4a1_mstock_grip2","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15_bk_top","rhsusf_acc_ACOG3",["rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red",30],[],"rhsusf_acc_grip2"],[],["rhs_weap_M320","","","",["rhs_mag_M433_HEDP",1],[],""],["rhs_uniform_g3_mc",[["ACE_MapTools",1],["ACE_quikclot",10],["ACE_morphine",1],["ACE_microDAGR",1],["ACE_tourniquet",4],["ACRE_PRC152_ID_1",1],["ACRE_PRC152_ID_4",1],["Laserbatteries",1,1]]],["rhsusf_plateframe_grenadier",[["ACRE_PRC152_ID_9",1],["rhs_mag_m716_yellow",2,1],["rhs_mag_m713_Red",2,1],["ACE_Chemlight_HiRed",2,1],["SmokeShell",2,1],["SmokeShellBlue",2,1],["SmokeShellPurple",2,1],["rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red",5,30],["B_IR_Grenade",2,1],["rhs_mag_M664_red_cluster",2,1],[["Laserdesignator","","","",[],[],""],1],[["ACE_Vector","","","",[],[],""],1]]],["B_TacticalPack_oli",[["ACE_HuntIR_monitor",1],["rhs_mag_m716_yellow",4,1],["SmokeShellBlue",2,1],["SmokeShellOrange",2,1],["SmokeShellYellow",2,1],["rhs_mag_m713_Red",2,1],["ACE_HuntIR_M203",5,1],["rhs_mag_M664_red_cluster",5,1]]],"rhsusf_opscore_ut_pelt_nsw_cam","rhs_googles_clear",["ACE_MX2A","","","",[],[],""],["ItemMap","ItemcTab","","ItemCompass","ItemWatch","rhsusf_ANPVS_15"]];
};
