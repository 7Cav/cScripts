...
class Cav_B_A_Plane_Fighter_Pilot_F : Cav_B_Alpha_base_F {
    ...
    scope = 2;
    loadout = [[],[],["rhsusf_weap_m9","","","",["rhsusf_mag_15Rnd_9x19_JHP",15],[],""],["U_B_PilotCoveralls",[["ACRE_PRC152",2],["ACRE_PRC343",1],["ACE_quikclot",5],["ACE_tourniquet",2],["ACE_MapTools",1],["ACE_IR_Strobe_Item",1],["ACE_Flashlight_MX991",1],["ACE_microDAGR",1]]],[],["B_AssaultPack_mcamo",[["rhsusf_mag_15Rnd_9x19_JHP",2,15],["Chemlight_green",1,1],["Chemlight_red",1,1],["ACE_Chemlight_HiYellow",1,1],["SmokeShell",1,1],["SmokeShellGreen",1,1],["SmokeShellRed",1,1],["B_IR_Grenade",2,1]]],"H_PilotHelmetFighter_B","",[],["ItemMap","ItemAndroid","ItemRadioAcreFlagged","ItemCompass","ACE_Altimeter",""]];
    role = "pilotfighter";
};
