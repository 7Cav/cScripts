...
class Cav_B_B_Weapons_M240B_FireTeamLeader_F: cScripts_B_B_Weapons_Rifleman_F {
    ...
    scope = 2;
    loadout = [["rhs_weap_m4a1_blockII","rhsusf_acc_SF3P556","rhsusf_acc_anpeq15_bk","rhsusf_acc_ACOG_RMR_3d",["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan",30],[],""],[],[],["USP_G3C_RS2_KP_OR_MC",[["ACE_quikclot",10],["kat_chestSeal",2],["kat_guedel",1],["ACE_tourniquet",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_microDAGR",1],["ACE_CableTie",2],["ACE_splint",2],["ACE_IR_Strobe_Item",1],["ACE_SpraypaintRed",1],["kat_Painkiller",1,4],["ACE_Chemlight_IR",2,1]]],["USP_CRYE_CPC_COMMS_BELT_MC",[["ACE_EntrenchingTool",1],["USP_PVS15",1],["SmokeShell",4,1],["HandGrenade",2,1],["rhs_mag_30Rnd_556x45_M855A1_PMAG_Tan_Tracer_Red",9,30],["SmokeShellBlue",2,1],["rhsusf_100Rnd_762x51_m62_tracer",1,100]]],["USP_ZIPON_PANEL_CPC_MC",[["rhsusf_100Rnd_762x51_m62_tracer",3,100]]],"USP_OPSCORE_FASTMTC_CMSW","",["ACE_Vector","","","",[],[],""],["ItemMap","ItemAndroid","","ItemCompass","ACE_Altimeter",""]];    
    icon = "iconManLeader";
};
