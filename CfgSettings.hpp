class CfgSettings {
    ...
    aiSystemDifficulty          =   2;      // 0: Standard, 1: Dessert, 2: Dumb As Fuck (Default: 0)
    ...
    useHeloGetOutRL             =   1;      // 0 or 1 Allow the mission to add Get Out Left/Right on helicopters spawned helos. (Default: 1)
